...
class ModelEndpointMetadata(ObjectMetadata, ModelEndpointParser):
    # ML-12736: the name patterns use look-ahead, unsupported by pydantic v2's default Rust
    # regex engine; python-re restores the v1 (Python re) behavior. extra="allow" is inherited
    # from ObjectMetadata and re-stated for clarity.
...
class ModelEndpointInstruction(BaseModel):
    ...
    # ML-12736: MODEL_ENDPOINT_ID_PATTERN uses look-ahead -> needs pydantic's python-re engine.
