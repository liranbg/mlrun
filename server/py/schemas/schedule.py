...
class ScheduleInput(BaseModel):
    name: str
    kind: ScheduleKinds
    # pydantic v1 treats a bare ``Any`` field as optional (default None); pydantic v2 makes
    # it required, so the default is restored explicitly to preserve the v1 contract.
